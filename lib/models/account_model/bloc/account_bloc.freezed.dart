...
/// @nodoc
abstract class _$$ApiURLChangedImplCopyWith<$Res> {
  factory _$$ApiURLChangedImplCopyWith(
          _$ApiURLChangedImpl value, $Res Function(_$ApiURLChangedImpl) then) =
      __$$ApiURLChangedImplCopyWithImpl<$Res>;
  @useResult
  $Res call({String apiURL});
}

/// @nodoc
class __$$ApiURLChangedImplCopyWithImpl<$Res>
    extends _$AccountEventCopyWithImpl<$Res, _$ApiURLChangedImpl>
    implements _$$ApiURLChangedImplCopyWith<$Res> {
  __$$ApiURLChangedImplCopyWithImpl(
      _$ApiURLChangedImpl _value, $Res Function(_$ApiURLChangedImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ApiURLChangedImpl(
      null == apiURL
          ? _value.apiURL
...
class _$ApiURLChangedImpl implements _ApiURLChanged {
  const _$ApiURLChangedImpl(this.apiURL);
  ...
  @override
  String toString() {
    return 'AccountEvent.apiURLChanged(apiURL: $apiURL)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ApiURLChangedImplCopyWith<_$ApiURLChangedImpl> get copyWith =>
      __$$ApiURLChangedImplCopyWithImpl<_$ApiURLChangedImpl>(this, _$identity);
...
abstract class _ApiURLChanged implements AccountEvent {
  const factory _ApiURLChanged(final String apiURL) = _$ApiURLChangedImpl;
